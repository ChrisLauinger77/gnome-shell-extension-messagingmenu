...
class AdwPrefs {
  ...
  _page1() {
    let email_setting_switch = this._builder.get_object("email_setting_switch");
    this._settings.bind(
      "notify-email",
    ...
    let chat_setting_switch = this._builder.get_object("chat_setting_switch");
    this._settings.bind(
      "notify-chat",
      chat_setting_switch,
      "active",
    ...
    let color_setting_button = this._builder.get_object("color_setting_button");
  ...
  _pages() {
    let apps = this._settings.get_string("compatible-emails").split(";").sort();
